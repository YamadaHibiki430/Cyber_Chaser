...
inline XMVECTOR XMVectorFromVector4(const _Vector4& vec4)
{
    return XMVectorSet(vec4.x, vec4.y, vec4.z, vec4.w);
}

inline _Vector4 XMVectorToVector4(FXMVECTOR V)
{
    _Vector4 vec4 = { XMVectorGetX(V), XMVectorGetY(V), XMVectorGetZ(V), XMVectorGetW(V) };
    return vec4;
}
...
typedef struct _NUI_SKELETON_FRAME
    ...
    DWORD dwFrameNumber;
    DWORD dwFlags;
    _Vector4 vFloorClipPlane;
    _Vector4 vNormalToGravity;
...
typedef struct _NUI_SKELETON_BONE_ROTATION
    {
    _Matrix4 rotationMatrix;
    _Vector4 rotationQuaternion;
...
EXTERN_C const IID IID_INuiCoordinateMapper;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE MapColorFrameToSkeletonFrame( 
            ...
            /* [size_is][out][in] */ _Vector4 *pSkeletonPoints) = 0;
...
EXTERN_C const IID IID_INuiSensor;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE NuiAccelerometerGetCurrentReading( 
            /* [retval][out] */ _Vector4 *pReading) = 0;
