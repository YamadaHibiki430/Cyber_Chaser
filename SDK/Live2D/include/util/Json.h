...
{ 
	...
	public:
		static Value * 	ERROR_VALUE;			// �?���?��返り値として返すエラー�?2D_DELETEしな�?���?��する。rootとして保持する場合�?new Error(とする
												// ERRORからERROR_VALUEに修正 ( DirectXにてWinGDI.hのERRORマクロと重�?��て問題になるた�?)
		static Value * 	NULL_VALUE;				// �?���?��返り値として返すNULL�?2D_DELETEしな�?���?��する
	...
	private:
		int encoding;			// マルチバイト文字�?エンコー�?��ング
		int line_count;			// エラー報告用
		const char *error;		// パ�?ス時�?エラー
		Value *root;			// パ�?スされたルートデータ
